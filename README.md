...
| GLM              | Refresh Token | Yes   | GLM-5.3, GLM-5.1                                                                                                                                                                                                                                 |
| Kimi             | JWT Token     | Yes   | Kimi-K3, Kimi-K2.6                                                                                                                                                                                                                               |
| MiniMax          | JWT Token     | Yes   | MiniMax-M3, MiniMax-M2.7                                                                                                                                                                                                                          |
| Mimo             | Cookie        | Yes   | MiMo-V2.5-Pro, MiMo-V2.5, MiMo-V2-Flash                                                                                                                                                                                                         |
| Perplexity       | Cookie        | Yes   | Auto                                                                                                                                                                                                                                           |
| Qwen (CN)        | SSO Ticket    | Yes   | Qwen3.8-Max, Qwen3.6, Qwen3.7-Max, Qwen3.5-Flash, Qwen3-Max, Qwen3-Max-Thinking-Preview, Qwen3-Coder                                                                                                                                                         |
| Qwen AI (Global) | JWT Token     | Yes   | Qwen3.8-Max, Qwen3.7-Plus, Qwen3.7-Max, Qwen3.6-Plus                                                                                                                                                                              |
...
Download the latest release from [GitHub Releases](https://github.com/wxs0625/Chat2API-WXS/releases):
...
git clone https://github.com/wxs0625/Chat2API-WXS.git
cd Chat2API-WXS
...
Check for updates in the **About** page, or download the latest version from [GitHub Releases](https://github.com/wxs0625/Chat2API-WXS/releases).
