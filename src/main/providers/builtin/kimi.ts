...
export const kimiConfig: BuiltinProviderConfig = {
  ...
  // www.kimi.com is mainland-China only.
  ...
  enabled: true,
  description: 'Kimi K3 AI assistant by Moonshot (kimi.ai), supports thinking mode and web search',
  supportedModels: [
    'Kimi-K3',
    'Kimi-K2.6',
  ],
  ...
  credentialFields: [
    {
      ...
      helpText: '登录 www.kimi.ai 后，从浏览器 Cookie 的 kimi-auth 字段获取（推荐），或从 DevTools Network 的 Authorization 头复制 JWT Token',
    },
  ],
